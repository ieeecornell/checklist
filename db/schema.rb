...
ActiveRecord::Schema.define(version: 20171026221700) do
  ...
  create_table "groups", force: :cascade do |t|
    t.string  "name"
    t.integer "course_ids", default: [], array: true
    t.index ["course_ids"], name: "index_groups_on_course_ids", using: :gin
  end
